...
$( document ).ready(function() {
    if (window.location.pathname == "/Flowy/"){
        document.getElementById('header_logo').src = 'Flowy/help/img/Logo_Flowy.svg';
        document.getElementById('header_shopping_cart').src = 'Flowy/help/img/shopping_cart_1.svg';
        document.getElementById('footer_copyright_symbol').src = 'Flowy/help/img/cophyright_symbol.svg';
        document.getElementById('footer_ubication_symbol').src = 'Flowy/help/img/ubication_symbol.svg';
        document.getElementById('footer_at_symbol').src = 'Flowy/help/img/at_sing.svg';
        document.getElementById('footer_up_arrow_symbol').src = 'Flowy/help/img/up_arrow.svg';
    }
  });
